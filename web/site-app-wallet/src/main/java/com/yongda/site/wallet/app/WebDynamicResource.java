...
public class WebDynamicResource implements Serializable {
    ...
    private String            walletH5Address;
	...
	/**话费充值异步调用地址*/
	private String walletrechargeReturnUrl;
	...
	public String getWalletH5Address() {
		return walletH5Address;
	}

	public void setWalletH5Address(String walletH5Address) {
		this.walletH5Address = walletH5Address;
	}
	...
	public String getMagSignkey() {
		return magSignkey;
	}

	public void setMagSignkey(String magSignkey) {
		this.magSignkey = magSignkey;
	}
    ...
    public String getWalletrechargeReturnUrl() {
        return walletrechargeReturnUrl;
    }

    public void setWalletrechargeReturnUrl(String walletrechargeReturnUrl) {
        this.walletrechargeReturnUrl = walletrechargeReturnUrl;
    }
