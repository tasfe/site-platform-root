...
public class Core {
    ...
    //生产
    public static String pfxFileName = "/opt/pay/config/basis/site/personal/cert/suka.pfx";
    public static String certFileName = "/opt/pay/config/basis/site/personal/cert/scgongyao.cer";
    //测试
   /* public static String pfxFileName = "/opt/pay/config/basis/site/personal/cert/ltx1.pfx";
    public static String certFileName = "/opt/pay/config/basis/site/personal/cert/laitianx.cer";*/
    //本地
//    public static String pfxFileName = "D:/opt/pay/opt1/config/basis/site/personal/cert/200000965018.pfx";
//    public static String certFileName = "D:/opt/pay/opt1/config/basis/site/personal/cert/laitianx.cer";
