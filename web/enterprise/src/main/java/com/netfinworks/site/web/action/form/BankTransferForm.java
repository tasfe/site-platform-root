...
public class BankTransferForm implements Serializable {
    ...
    // 收款方银行开户名
    @Pattern(regexp = RegexRule.ACCOUNT_NAME, message = "银行开户名不能超过20个字")
    private String            recvAcctName;

    // 目标账户
    @Pattern(regexp = RegexRule.BANKCARD_NO, message = "银行卡号必须是8~32位的数字")
    ...
    // 转账成功总数
    private String            transferSuccessCount;

    // 转账成功金额
    private String            transferSuccessAmount;

    // 转账失败总数
    private String            transferFailCount;
    ...
    public String getTransferSuccessCount() {
        return transferSuccessCount;
    }

    public void setTransferSuccessCount(String transferSuccessCount) {
        this.transferSuccessCount = transferSuccessCount;
    }

    public String getTransferFailCount() {
        return transferFailCount;
    }

    public void setTransferFailCount(String transferFailCount) {
